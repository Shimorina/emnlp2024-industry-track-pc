...
def send_email_reviewer_subgroup(rev_group):
    ...
    subject = '[EMNLP Industry Track 2025] Reminder papers has been assigned on OpenReview'
    ...
    for profile in profiles:
        ...
        message = f'Dear {first_name},\n\n' \
                  ...
                  f'As you know, you can now consult the assigned papers on OpenReview.\n' \
                  f'or check the assigned papers in : https://openreview.net/group?id=EMNLP/2025/Industry_Track/{rev_group}#assigned-submissions \n\n' \
                  f'*** Some Important Dates ***\n'\
                  f'** Assign reviewers to papers : July 15 \n'\
                  f'** Review period : July 15 - August 9 \n'\
                  f'** Reviewer-author discussion period : August 28 - Sept 4 \n'\
                  f'Thank you!\n\n' \
                  f'Best Regards,\n' \
